...
<details>
<summary><b>[115] LibreCaslonText-VF.ttf</b></summary>
<details>
...
|  | fonts/LibreCaslonText-VF.ttf |
|:--- | ---:|
| Dehinted Size | 124.0kb |
| Hinted Size | 151.0kb |
| Increase | 27.0kb |
| Change   | 21.7 % |
...
* :information_source: **INFO** Version string is: "Version 1.002; ttfautohint (v1.8.1.43-b0c9) -l 8 -r 50 -G 200 -x 14 -D latn -f none -a qsq -X """
...
* :information_source: **INFO** This font contains the following optional tables [loca, fpgm, GSUB, gasp, prep, GPOS, DSIG, cvt ]
...
* :bread: **PASS** fonts/LibreCaslonText-VF.ttf is named canonically.
