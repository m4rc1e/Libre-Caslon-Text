...
* :bread: **PASS** fonts/librecaslontext/DESCRIPTION.en_us.html is a propper HTML file.
...
<details>
<summary><b>[111] LibreCaslonText-Medium.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Libre Caslon Text Medium" while METADATA.pb has "Libre Caslon Text" [code: mismatch]
...
* :fire: **FAIL** METADATA.pb Family name "Libre Caslon Text") does not match name table entry "Libre Caslon Text Medium" ! [code: familyname-mismatch]
...
* :bread: **PASS** fontforge-check: Contours have correct directions.
...
* :warning: **WARN** fontforge-check: Glyphs do not have points at extremas!
...
|  | fonts/librecaslontext/LibreCaslonText-Medium.ttf |
|:--- | ---:|
| Dehinted Size | 76.6kb |
| Hinted Size | 103.6kb |
| Increase | 27.0kb |
| Change   | 0.4 % |
...
* :information_source: **INFO** This font contains the following optional tables [fpgm, GPOS, loca, prep, DSIG, GSUB, gasp, cvt ]
...
* :bread: **PASS** fonts/librecaslontext/LibreCaslonText-Medium.ttf is named canonically.
...
* :bread: **PASS** Postscript name "LibreCaslonText-Medium" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** Font fullname "Libre Caslon Text Medium" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.name field contains font name in right format. ('Libre Caslon Text' in 'Libre Caslon Text')
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Libre Caslon Text' in 'Libre Caslon Text Medium')
...
<details>
<summary>:bread: <b>PASS:</b> Copyright notice on METADATA.pb matches canonical pattern?</summary>
