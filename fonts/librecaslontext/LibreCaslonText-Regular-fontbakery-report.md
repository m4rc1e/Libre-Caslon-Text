...
<details>
<summary><b>[117] LibreCaslonText-Regular.ttf</b></summary>
<details>
...
|  | fonts/librecaslontext/LibreCaslonText-Regular.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [GSUB, GPOS, fpgm, loca, cvt , gasp, DSIG, prep]
...
* :bread: **PASS** fonts/librecaslontext/LibreCaslonText-Regular.ttf is named canonically.
...
* :bread: **PASS** Postscript name "LibreCaslonText-Regular" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** Font fullname "Libre Caslon Text Regular" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Libre Caslon Text' in 'Libre Caslon Text Regular')
