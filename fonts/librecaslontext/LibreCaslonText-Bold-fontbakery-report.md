...
|  | fonts/librecaslontext/LibreCaslonText-Bold.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [loca, prep, DSIG, GPOS, fpgm, gasp, cvt , GSUB]
...
* :bread: **PASS** fonts/librecaslontext/LibreCaslonText-Bold.ttf is named canonically.
...
* :bread: **PASS** Postscript name "LibreCaslonText-Bold" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** Font fullname "Libre Caslon Text Bold" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Libre Caslon Text' in 'Libre Caslon Text Bold')
