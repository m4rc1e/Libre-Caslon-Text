...
shortSample = "anbncndnenfngnhninjnknlnmnnnonpnqnrnsntnunvnwnxnynzanbncndnenfngnhninjnknlnmnnnonpnqnrnsntnunvnwnxnynznanbncndnenfngnhninjnknlnmnnnonpnqnrnsntnunvnwnxnynzanbncndnenfngnhninjnknlnmnnnonpnqnrnsntnunvnwnxnynz"

pangrams = "přílišžluťoučkýkůňúpělďábelskéódyngodstilmåførstogfremstværeklardenmåværepassendearistotelesskrzyń"
...
for page in range(6):
    ...
    for line in range(lines):
        ...
        placeText("./LibreCaslonText-VF.ttf",margin,topMargin, line, weight=caslonWeight)
        placeText("./LibreCaslonText-Italic.ttf",margin,topMargin+boxHeight, line)
