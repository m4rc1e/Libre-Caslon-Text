...
* :information_source: **INFO** MS-FonVal: Unable to perform test due to previously detected errors DETAILS: 
	...
	- NOTE: 38 other similar results were hidden!
...
* :information_source: **INFO** MS-FonVal: Total time validating file DETAILS: 0:00:21
...
* :bread: **PASS** MS-FonVal: Font checksum is correct DETAILS: 0xd252f9d6
...
* :bread: **PASS** MS-FonVal: The created time is not zero DETAILS: created = 3624644360 (Friday, November 9, 2018 9:39 PM)
* :bread: **PASS** MS-FonVal: The xMin value matches the minimum glyph xMin DETAILS: xMin = -276
* :bread: **PASS** MS-FonVal: The yMin value matches the minimum glyph yMin DETAILS: yMin = -458
* :bread: **PASS** MS-FonVal: The xMax value matches the maximum glyph xMax DETAILS: xMax = 2560
...
* :warning: **WARN** MS-FonVal: The modified time is an unlikely value DETAILS: modified = 3625616890 (Wednesday, November 21, 2018 3:48 AM)
